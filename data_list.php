...
<div class="container">
                    <h4>แสดงชื่อหนัง</h4>
                    <a href="data_add.php" class="btn btn-link">เพิ่มชื่อหนัง</a>
                    <div class="container">
                    ...
                    <?php
                        include 'connect.php';                        
                        $sql =  'SELECT * FROM data order by data_id';
                        ...
                        while (($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) != NULL) {
                            ...
                            echo '<td>';
                            ?>
                                <a href="data_edit.php?data_id=<?php echo $row['data_id'];?>" class="btn btn-warning">แก้ไข</a>
                                <a href="JavaScript:if(confirm('ยืนยันการลบ')==true)
                                   {window.location='data_delete.php?data_id=<?php echo $row["data_id"];?>'}" class="btn btn-primary">ลบ</a>
                            <?php
                                    echo '</td>';                            
                            echo '</tr>';
                        }
