...
<html lang="en">
  ...
  <body>
      ...
      <div class="col-sm-4 col-md-5">
                    <h4>แก้ไขชื่อหนังสูงสุด</h4>
                    <?php
                        $drt_id = $_REQUEST['drt_id'];
                        if(isset($_GET['submit'])){
                            $data_id = $_GET['data_id'];
                            $data_TH = $_GET['data_TH'];
                            $data_EN = $_GET['data_EN'];
                            $sql = "update data set ";
                            $sql .= "data_TH='$data_TH',data_drt_id='$data_drt_id' ";
                            $sql .="where data_id='$data_id' ";
                            include 'connect.php';
                            mysqli_query($conn,$sql);
                            mysqli_close($conn);
                            echo "แก้ไขชื่อหนัง เรียบร้อยแล้ว<br>";
                            header('refresh: 2; director.php');
                            echo '<a href="director.php">แสดงชื่อหนังทั้งหมด</a>';
                    ...
                    <form class="form-horizontal" role="form" name="data_edit" action="<?php echo $_SERVER['PHP_SELF'];?>">
                        ...
                        <div class="form-group">
                            <label for="lct_name" class="col-md-2 col-lg-2 control-label">คำนำหน้า</label>
                            <div class="col-md-10 col-lg-10">
